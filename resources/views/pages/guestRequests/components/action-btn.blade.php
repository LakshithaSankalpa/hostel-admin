<div class="dropdown mr-2">
    ...
    <div class="dropdown-menu w-40">
        <ul class="dropdown-content">
            <li>
                @if ($status == $this->guestRequestStatus('UNREAD'))
                <a class="flex items-center text-success dropdown-item" wire:click="readMessage('{{$id  }} ')"
                    href="javascript:;">
                ...
                @else
                <a class="flex items-center text-red-500 dropdown-item" wire:click="unreadMessage('{{  $id}}')"
                    href="javascript:;">
                    <svg class="w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
