        ...
        <div class="flex flex-row justify-center md:justify-start mb-2 md:mb-0">
            <div class="relative h-10">
                ...
                <select wire:model.lazy="perPage"
                        class="block appearance-none bg-gray-50 border border-gray-300 text-gray-700 py-2 px-3 pr-5 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500  dark:bg-gray-500 dark:text-gray-200 dark:placeholder-gray-200 dark:border-gray-500">
